...
function preload()
{
  ...
  juego.load.image('piso2', 'imagenes/Norte/piso.png');
  juego.load.image('plat', 'imagenes/Norte/plataforma_1x1.png');
  juego.load.image('plat1', 'imagenes/Norte/piso2.png');
  ...
  juego.load.image('piso3', 'imagenes/Norte/piso3.png');
...
function create()
{
  ...
  let plat=plataformas.create(680,560,"plat")
  let plat1=plataformas.create(350,560,"plat1")
  let plat2=plataformas.create(791,560,"plat2")
  let plat3=plataformas.create(450,200,"plat3")
  let plat4=plataformas.create(700,300,"plat4")
  let piso=plataformas.create(0,560,"piso")
  let piso3=plataformas.create(500,560,"piso3")
